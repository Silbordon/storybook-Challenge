...
/* harmony export */   LinkButtonBase: () => (/* binding */ LinkButtonBase),
...
//@ts-ignore
_c = Template;
const LinkButtonBase = Template.bind({});
LinkButtonBase.args = {
  to: "*",
  text: "Link 1"
};
...
LinkButtonBase.parameters = {
  ...LinkButtonBase.parameters,
  docs: {
    ...LinkButtonBase.parameters?.docs,
    source: {
      originalSource: "args => <LinkButton {...args} />",
      ...LinkButtonBase.parameters?.docs?.source
    }
  }
};;const __namedExportsOrder = ["LinkButtonBase"];
...
//# sourceMappingURL=components-atoms-LinkButton-LinkButton-stories.ec648d6565574f89de8a.hot-update.js.map