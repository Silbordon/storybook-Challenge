"use strict";
globalThis["webpackHotUpdatechallenge"]("components-atoms-Button-Button-stories",{
...
Buttonbase.parameters = {
  ...Buttonbase.parameters,
  docs: {
    ...Buttonbase.parameters?.docs,
    source: {
      originalSource: "{\n  args: {}\n}",
      ...Buttonbase.parameters?.docs?.source
    }
  }
};;const __namedExportsOrder = ["Buttonbase"];
...
try {
    ...
    // @ts-ignore
    Button.__docgenInfo = { "description": "", "displayName": "Button", "props": { "text": { "defaultValue": null, "description": "", "name": "text", "required": true, "type": { "name": "string" } }, "onClick": { "defaultValue": null, "description": "", "name": "onClick", "required": false, "type": { "name": "(() => void)" } } } };
    // @ts-ignore
...
//# sourceMappingURL=components-atoms-Button-Button-stories.48358f200d6e5c8d053f.hot-update.js.map